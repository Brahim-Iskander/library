...
import MonthlyEmpruntsChart from "../components/MonthlyEmpruntsChart";
...
function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    // Global stats
    axios.get("http://localhost:8090/api/admin/stats", config)
      .then(res => setStats(res.data))
      .catch(err => console.error(err));

    // Monthly emprunts
    axios.get("http://localhost:8090/api/admin/monthly-emprunts", config)
      .then(res => setMonthlyEmprunts(res.data))
      .catch(err => console.error(err));

    // Top books
    axios.get("http://localhost:8090/api/admin/top-books", config)
      .then(res => setTopBooks(res.data))
      .catch(err => console.error(err));

    // Top students
    axios.get("http://localhost:8090/api/admin/top-students", config)
